...
-- Dump completed on 2025-07-01 14:21:16
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: task_data
-- ------------------------------------------------------
-- Server version	9.2.0
...
CREATE TABLE `tasks` (
  ...
  `task_author` varchar(50) NOT NULL,
  `task_assignee` varchar(50) NOT NULL,
  `created_date` varchar(50) NOT NULL,
  `due_date` varchar(50) NOT NULL,
  `task_priority` varchar(10) NOT NULL,
  `task_status` varchar(15) NOT NULL,
  `company_id` int NOT NULL,
  PRIMARY KEY (`id`,`task_name`,`task_author`,`task_assignee`)
...
CREATE TABLE `users` (
  ...
  `company_id` int NOT NULL,
  PRIMARY KEY (`id`,`email`,`password_hash`,`company_id`),
...
-- MySQL dump 10.13  Distrib 8.0.42, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: companies_data
-- ------------------------------------------------------
-- Server version	9.2.0
